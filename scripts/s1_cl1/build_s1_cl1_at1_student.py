...
MARKING_A = [
    ...
    ['A5 - Appendix 1 Cost-Benefit Analysis — you completed the 5-year CBA covering both options with line-item detail in Appendix 1; assumptions stated, each with its source; year-by-year projections; comparison summary; avoided-downtime benefit. Numbers reconcile between Appendix 1 detail, summary, and Executive Summary '],
