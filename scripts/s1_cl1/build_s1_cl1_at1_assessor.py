...
MARKING_A = [
    ...
    ['A13 - §12 Feedback — completed during/after the Part B presentation event; one row per item of board feedback received, with the student\'s response and the resulting action ', '[ICTICT517 PC 2.4] (documented evaluation provided to superior for feedback)'],
...
MARKING_B = [
    ...
    ['B2 - The documented evaluation process (CBA + analysis from §6–§8) is provided to the superior at/before the meeting; student walks the superior through it for feedback during the meeting ', '[ICTICT517 PC 2.4] (the act of providing + walking through — A13 covers the captured feedback afterwards)'],
